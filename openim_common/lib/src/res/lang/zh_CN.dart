const Map<String, String> zh_CN = {
  ...
  "themeClassic": "经典蓝",
  "themeCyberCyan": "赛博潮汐",
  "themeMatrixGreen": "矩阵绿洲",
  "themeNeonPurple": "霓虹脉冲",
  "themeMechaRed": "机甲赤焰",
  "themeIceBlue": "极地冰蓝",
  "language": "语言",
  "english": "English",
...
const Map<String, String> errorMessages = {
  ...
  'redPacketAmount': '总金额',
  'redPacketCount': '红包个数',
  'luckyRedPacket': '拼手气红包',
  'normalRedPacket': '普通红包',
  'openRedPacket': '开',
  'redPacketOpened': '已领取',
  'redPacketFrom': '%s的红包',
  'redPacketDefaultGreeting': '恭喜发财，大吉大利',
  'plsEnterRedPacketAmount': '请输入红包金额',
  'redPacketAmountLimit': '单个红包金额不可超过%s元',
  'redPacketCountLimit': '红包个数不可超过%s个',
  'redPacketBalance': '红包金额',
