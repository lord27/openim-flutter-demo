const Map<String, String> en_US = {
  ...
  "themeCyberCyan": "Cyber Tide",
  "themeMatrixGreen": "Matrix Oasis",
  "themeNeonPurple": "Neon Pulse",
  "themeMechaRed": "Mecha Crimson",
  "themeIceBlue": "Polar Ice",
  "language": "Language",
  "english": "English",
  "chinese": "简体中文",
...
const Map<String, String> errorMessages = {
  ...
  'toolboxRedPacket': 'Red Packet',
  'sendRedPacket': 'Send Red Packet',
  'redPacketGreeting': 'Greeting',
  'redPacketAmount': 'Total Amount',
  'redPacketCount': 'Quantity',
  'luckyRedPacket': 'Lucky Money',
  'normalRedPacket': 'Regular',
  'openRedPacket': 'Open',
  'redPacketOpened': 'Opened',
  'redPacketFrom': "%s's Red Packet",
  'redPacketDefaultGreeting': 'Best wishes!',
  'plsEnterRedPacketAmount': 'Please enter an amount',
  'redPacketAmountLimit': 'Amount cannot exceed %s',
  'redPacketCountLimit': 'Quantity cannot exceed %s',
  'redPacketBalance': 'Amount',

  // ===== Location =====
  'sendLocation': 'Send Location',
  'myLocation': 'My Location',
  'currentLocation': 'Current Location',
  'searchLocation': 'Search place',
  'locationName': 'Place name',
  'locationAddress': 'Address',
  'moveMapToSelect': 'Move the map to select',
  'locating': 'Locating…',
  'locationFailed': 'Location failed',
  'locationServiceDisabled': 'Location service is off',
